...
module.exports = function (app, passport, mongoose) {
	...
	// NEW DASHBOARD
	var key = require('../node_modules/dashboard-d8a027d868dc.json');
				  ...
				  jwtClient.authorize(function(err, tokens){
						  ...
						  queryData(analytics, "ga:92206921", function(query){
							queryData(analytics, "ga:91195968", function(queryBlog){
								console.log('grid: ' + JSON.stringify(docs.grid));
								res.render('dash/index', { grid: JSON.stringify(docs.grid), values: query, valuesBlog: queryBlog });
							});
						  });

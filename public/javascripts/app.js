...
if(thereIsAdmin != true) {
	...
	if(QueryString.mauticMessage != undefined){
		$('body').prepend('<div class="alert-box" data-alert style="margin-bottom: 0; height:60px;z-index:999;position:fixed;width:100%;background-color:#27B899;text-align:center"><p>' + QueryString.mauticMessage + '</p><a id="alertMessage" href="#" style="color:white;opacity:1;" class="close">&times;</a></div>')
	}
